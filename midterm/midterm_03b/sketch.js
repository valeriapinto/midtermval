...
var step = 14; // how much the turtle moves with each 'F'
var angle = 75; // how much the turtle turns with a '-' or '+'
...
function setup()
{
  createCanvas(2000, 1000); // this is the size of the window (I did it like this so that more of the design could be seen)
